...
class CertificationsControllerTest < ActionController::TestCase
  ...
  test "should create certification" do
    assert_difference('Certification.count') do
      post :create, certification: { completed_date: @certification.completed_date, expiry_date: @certification.expiry_date, name: @certification.name, user_id: @certification.user_id }
    end
  ...
  test "should update certification" do
    patch :update, id: @certification, certification: { completed_date: @certification.completed_date, expiry_date: @certification.expiry_date, name: @certification.name, user_id: @certification.user_id }
    assert_redirected_to certification_path(assigns(:certification))
  end
